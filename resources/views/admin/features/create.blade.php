...
@section('title', 'Tambah Fitur - ' . $schoolName)
    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
            <div class="p-6 bg-white border-b border-gray-200">
                <h1 class="text-2xl font-bold text-gray-900 mb-6">Tambah Fitur Baru</h1>
                ...
                <form action="{{ route('admin.features.store') }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="deskripsi" 
                                  ...
                                  rows="4"
                                  required
                                  class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">{{ old('deskripsi') }}</textarea>
                        @error('deskripsi')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select name="warna" 
                                    ...
                                    required
                                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                <option value="blue" {{ old('warna', 'blue') == 'blue' ? 'selected' : '' }}>Biru</option>
                                ...
                                <option value="pink" {{ old('warna') == 'pink' ? 'selected' : '' }}>Merah Muda</option>
