...
@section('title', 'Test Guru Staf Simple - Admin Panel')

@section('content')
<div class="p-6">
    <div class="bg-white rounded-lg shadow-md p-6">
        <h1 class="text-2xl font-bold text-gray-900 mb-4">Test Guru Staf Simple</h1>
        <p class="text-gray-600 mb-4">Halaman ini menggunakan layout sederhana tanpa Alpine.js untuk testing sidebar.</p>
        
        <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
            <h2 class="text-lg font-semibold text-blue-900 mb-2">Status Sidebar:</h2>
            <ul class="text-blue-800 space-y-1">
                <li>✅ Layout: admin-test (sederhana)</li>
