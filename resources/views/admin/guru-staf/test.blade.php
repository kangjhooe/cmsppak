...
@section('title', 'Test Guru Staf - Admin Panel')

@section('content')
<div class="p-6">
    <div class="bg-white rounded-lg shadow-md p-6">
        <h1 class="text-2xl font-bold text-gray-900 mb-4">Test Guru Staf Sidebar</h1>
        <p class="text-gray-600 mb-4">Halaman ini untuk testing apakah sidebar muncul di halaman guru-staf.</p>
