...
@section('title', 'Tambah Role Baru - ' . $schoolName)
        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-gradient-to-r from-orange-600 to-orange-700 rounded-xl p-6 text-white mb-6 shadow-lg">
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-2xl font-bold mb-2">Tambah Role Baru</h1>
                        <p class="text-orange-100">Buat role baru untuk sistem manajemen</p>
                    </div>
